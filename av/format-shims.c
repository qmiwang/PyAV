...
const AVOutputFormat* pyav_muxer_iterate(void **handle) {
    ...
    ptr = av_oformat_next(*<AVOutputFormat**>handle);
    *handle = ptr;
    return ptr;
...
const AVInputFormat* pyav_demuxer_iterate(void **handle) {
    ...
    ptr = av_iformat_next(*<AVInputFormat**>handle);
    *handle = ptr;
    return ptr;
